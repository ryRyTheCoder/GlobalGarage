...
public class Item {
    ...
    public boolean equals(Object o) {
        ...
        Item item = (Item) o;
        return Objects.equals(garageID, item.garageID) && Objects.equals(itemID, item.itemID) &&
                Objects.equals(sellerID, item.sellerID) && Objects.equals(name, item.name) &&
                Objects.equals(description, item.description) && Objects.equals(price, item.price) &&
                Objects.equals(category, item.category) && Objects.equals(images, item.images) &&
                Objects.equals(dateListed, item.dateListed) &&
                Objects.equals(buyersInterested, item.buyersInterested) && Objects.equals(status, item.status);
    }

    @Override
    public int hashCode() {
        return Objects.hash(garageID, itemID, sellerID, name, description, price,
                category, images, dateListed, buyersInterested, status);
    }
