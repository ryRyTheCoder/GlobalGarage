...
public class GetGaragesBySellerResult {
    ...
    private final String lastEvaluatedKey; // For pagination

    private GetGaragesBySellerResult(boolean success, String message, List<GarageModel> garageModels, String lastEvaluatedKey) {
